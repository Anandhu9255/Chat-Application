    ...
    <div className="min-h-screen w-screen bg-[#0b141a] flex items-center justify-center p-0">
      <div className="w-full max-w-md bg-[#111b21] rounded-lg p-6 mx-4">
        ...
        <form onSubmit={submit} className="space-y-4">
          ...
          <button className="w-full px-4 py-3 bg-[#25D366] text-white rounded-full font-semibold">Login</button>
        </form>
        <p className="mt-4 text-center text-sm text-gray-300">No account? <Link to="/register" className="text-[#25D366]">Register</Link></p>
      </div>
    </div>
  )
}